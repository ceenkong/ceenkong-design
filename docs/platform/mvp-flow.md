...
- Django internationalization for switchable English and Simplified Chinese UI text from the first platform slice.
...
- Users must be able to switch the active UI language between English and Simplified Chinese.
- The selected language should persist for the user or session. The exact control placement is a Stage 2 screen-structure decision.
